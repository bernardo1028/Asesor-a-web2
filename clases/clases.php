...
class usuarios{
	...
	{
		$con = conexion("root", "");
		$consulta = $con->prepare("insert into usuarios(CodUsua, nombre, usuario, correo, pass, profesion, edad, foto_perfil) values(null, :nombre, :usuario, :correo,:pass, :profe, :edad, :foto_perfil)");
	...
	{
		$con = conexion("root", "");
		$consulta = $con->prepare("update usuarios set nombre = :nombre, usuario = :usuario, profesion = :profesion,  correo = :correo, foto_perfil = :foto_perfil where CodUsua = :CodUsua");
		$consulta->execute(array(':nombre' => $datos[0],
								  ':usuario' => $datos[1],
                                  ':correo' => $datos[2],
								  ':profesion' => $datos[3],
